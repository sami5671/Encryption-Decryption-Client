...
const Login = () => {
  const { signIn, signInWithGoogle, gitHubSign, loading } = UseAuth();
  ...
  return (
    <>
      ...
      >
        ...
        <Container>
          <div className="relative z-10 flex flex-col-reverse lg:flex-row items-center justify-center gap-12 mt-12 mb-12">
            <div className="">
